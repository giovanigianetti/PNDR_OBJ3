...
def main() -> None:
    ...
    regional = json.loads((RAW / "municipios_intermediarias_ibge.json").read_text())
    records = []
        ...
        records.append(
            {
                ...
                "immediateCode": row["Código Região Geográfica Imediata"],
                "immediateName": row["Região Geográfica Imediata"],
                "rgiCode": regional[row["Código Município"]]["code"],
                "rgi": regional[row["Código Município"]]["name"],
